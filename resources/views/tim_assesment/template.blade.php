							...
							@foreach($top_notifikasis as $notifikasi)
								@if($notifikasi->status == 'belum')
									<li class="list-group-item unread">
										<a href="{{url('tim_assesment/detail_notifikasi/'.$notifikasi->id.'/'.$notifikasi->pekerja_id)}}">
	...
	<ul class="nav pmd-sidebar-nav">
		...
		<li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
				<div class="media-body media-middle">Admin Tim Assesment</div>
				<div class="media-right media-middle"><i class="dic-more-vert dic"></i></div>
			</a>
		</li><!-- End user info -->
		
		<li> 
			<a class="pmd-ripple-effect" href="{{ url('/tim_assesment')}}">	
		...
		<li class="dropdown pmd-dropdown"> 
			...
			<ul class="dropdown-menu">
				<li><a href="{{url('tim_assesment/daftar_permintaan')}}">Daftar Permintaan</a></li>
				<li><a href="{{url('tim_assesment/daftar_berkas_lulus')}}">Daftar Berkas Lulus</a></li>
				<li><a href="{{url('tim_assesment/daftar_berkas_tidak_lulus')}}">Daftar berkas Tidak Lulus</a></li>
			</ul>
		</li>

		<li> 
			<a class="pmd-ripple-effect" href="{{ url('tim_assesment/notifikasi')}}">	
		...
		<li> 
			<a class="pmd-ripple-effect" href="{{ url('logout_tim_assesment')}}">	
				<i class="media-left media-middle">
