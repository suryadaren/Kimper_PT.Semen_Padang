...
<link rel="stylesheet" type="text/css" href="{{ url('Admin/components/datetimepicker/css/bootstrap-datetimepicker.css')}}" />
<link rel="stylesheet" type="text/css" href="{{ url('Admin/components/datetimepicker/css/pmd-datetimepicker.css')}}" />
...
<!--circle chart-->
<script src="{{ url('Admin/themes/js/circles.min.js')}}"></script>
<script>
...
<script src="{{ url('Admin/themes/js/highcharts.js')}}"></script>
<script src="{{ url('Admin/themes/js/highcharts-more.js')}}"></script>
...
<script type="text/javascript" language="javascript" src="{{ url('Admin/components/datetimepicker/js/moment-with-locales.js')}}"></script>
<script type="text/javascript" language="javascript" src="{{ url('Admin/components/datetimepicker/js/bootstrap-datetimepicker.js')}}"></script>
<script>
