@extends('tim_assesment/template')
...
<div class="container-fluid full-width-container data-tables">
    ...
    <h1 class="section-title" id="services">
      <span>Daftar Permintaan izin berkas</span>
    </h1><!-- End Title -->
  
    <!--breadcrum start-->
    <ol class="breadcrumb text-left">
      <li><a href="{{ url('tim_assesment')}}">Dashboard</a></li>
      <li class="active">Permintaan izin berkas</li>
    </ol><!--breadcrum end-->
...
<!--tab start-->
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <form name="form_detail" class="form-horizontal" method="post">
                        ...
                        <fieldset>
                          ...
                          <div class="pmd-modal-action text-right">
                            <button class="btn pmd-ripple-effect btn-primary" type="button" onclick="lulus()">Lulus</button>
                            <button class="btn pmd-ripple-effect btn-danger" type="button" onclick="decline()">Tidak Lulus</button>
                          </div>
                      </form>
                    </div>
                  </div>
    ...
    <div class="container">
          ...
          <div class="modal fade" id="decline">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="myModalLabel">Decline Data</h4>
                </div>
                <div class="modal-body">
                  
                  <form name="form_decline" action="{{ url('tim_assesment/tolak_berkas')}}" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
    ...
    <div class="container">
          <!-- Modal -->
          <div class="modal fade" id="lulus">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="myModalLabel">Lulus</h4>
                </div>
                <div class="modal-body">
                  
                  <form name="form_lulus" action="{{ url('tim_assesment/terima_berkas')}}" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">

                      <input type="hidden" name="id"></div>

                      <div class="form-group">
                        <label for="exampleInputFile">Input Berkas Assesment</label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input name="berkas_assesment" type="file" class="pmd-file" required>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="modal-footer">
                      ...
                      <input type="button" class="btn btn-danger" data-dismiss="modal" value="Tutup">
                    </div>
                    {{csrf_field()}}
                    @method('put')
                  </form>
...
function detail(id,nama,nip,jenis_kelamin,tempat_lahir,tanggal_lahir,agama,golongan_darah,alamat,email,telepon,hp,jabatan,unit_kerja,alamat_kantor,riwayat_pendidikan,sertifikasi_keahlian,pendidikan_khusus){
      ...
      document.forms['form_decline']['id'].value=id;
      document.forms['form_lulus']['id'].value=id;
      $('#detail').modal('show');
