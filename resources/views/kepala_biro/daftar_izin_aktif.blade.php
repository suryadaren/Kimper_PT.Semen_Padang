...
<div class="container-fluid full-width-container data-tables">
    ...
    <h1 class="section-title" id="services">
      <span>Daftar Izin Aktif</span>
    </h1><!-- End Title -->
  
    <!--breadcrum start-->
    <ol class="breadcrumb text-left">
      <li><a href="{{ url('kepala_biro')}}">Dashboard</a></li>
      <li class="active">Izin Aktif</li>
    </ol><!--breadcrum end-->
          ...
          <table id="example" class="table pmd-table table-hover table-striped display responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr onclick="detail('{{$pekerja->id}}','{{$pekerja->nama}}','{{$pekerja->nip}}','{{$pekerja->jenis_kelamin}}','{{$pekerja->tempat_lahir}}','{{$pekerja->tanggal_lahir}}','{{$pekerja->agama}}','{{$pekerja->golongan_darah}}','{{$pekerja->alamat}}','{{$pekerja->email}}','{{$pekerja->telepon}}','{{$pekerja->hp}}','{{$pekerja->jabatan}}','{{$pekerja->unit_kerja}}','{{$pekerja->alamat_kantor}}','{{$pekerja->riwayat_pendidikan}}','{{$pekerja->sertifikasi_keahlian}}','{{$pekerja->pendidikan_khusus}}')">
                ...
                <td>{{$pekerja->nama}}</td>
                <td>{{$pekerja->email}}</td>
                <td>{{$pekerja->tgl_aktif}}</td>
                <td>{{$pekerja->tgl_expired}}</td>
              </tr>
              @endforeach
            </tbody>
          </table>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <form name="form_detail" class="form-horizontal" action="" method="post">
                        ...
                        <fieldset>
                          ...
                          <div class="pmd-modal-action text-right">
                            <button class="btn btn-danger pmd-ripple-effect" type="button" data-dismiss="modal">Tutup</button>
                          </div>
                          {{csrf_field()}}
                          @method('put')
                      </form>
