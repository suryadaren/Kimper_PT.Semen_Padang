...
<div class="container-fluid full-width-container data-tables">
    ...
    <ol class="breadcrumb text-left">
      <li><a href="{{ url('kepala_biro')}}">Dashboard</a></li>
      <li><a href="{{ url('kepala_biro/daftar_permintaan')}}">Permintaan izin berkas</a></li>
          ...
          <div class="pmd-card-body">
            <dl class="dl-horizontal">
              <fieldset>
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="form-group pmd-textfield">
                      <label class="col-sm-3 control-label" for="u_fname">Berkas Assesment</label>
                      <div class="col-sm-9">
                        <img src="{{url('Admin/file.ico')}}" style="width: 50px;margin-left: 50px">
                        <br>
                        <br>
                        <a href="{{url('berkas_assesment/'.$pekerjas->berkas_assesment)}}" download><button class="btn btn-success">download</button></a>
                        <br>
                      </div>
                    </div>
                </div>
              ...
              <div class="pmd-modal-action text-right">
                <button class="btn pmd-ripple-effect btn-primary" onclick="lulus('{{$pekerjas->id}}')">Izin Diaktifkan</button>
                <a href="{{url('kepala_biro/daftar_permintaan')}}" class="btn pmd-ripple-effect btn-default">Kembali</a>
              </div>
            </dl>
          </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form name="form_lulus" action="{{ url('kepala_biro/izin_aktif')}}" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">

                      <input type="hidden" name="id"></div>

                      <div class="form-group">
                        <label for="exampleInputFile">Input Tanggal expired masa aktif</label>
                        <input type="date" name="tgl_expired" placeholder="Tanggal Lahir" class="form-control">
                      </div>
