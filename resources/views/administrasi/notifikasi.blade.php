          ...
          <table id="example" class="table pmd-table table-hover table-striped display responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{url('administrasi/detail_notifikasi/'.$notifikasi->id.'/'.$notifikasi->pekerja_id)}}" class="btn btn-primary">Detail</a></td>
                @else
                <td><a href="{{url('administrasi/detail_notifikasi/'.$notifikasi->id.'/'.$notifikasi->pekerja_id)}}" class="btn btn-danger">Detail</a></td>
                @endif
              </tr>
              @endforeach
            </tbody>
