							...
							@foreach($top_notifikasis as $notifikasi)
								@if($notifikasi->status == 'belum')
									<li class="list-group-item unread">
										<a href="{{url('administrasi/detail_notifikasi/'.$notifikasi->id.'/'.$notifikasi->pekerja_id)}}">
	...
	<ul class="nav pmd-sidebar-nav">
		...
		<li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
				<div class="media-body media-middle">Admin Administrasi</div>
				<div class="media-right media-middle"><i class="dic-more-vert dic"></i></div>
			</a>
		</li><!-- End user info -->
		
		<li> 
			<a class="pmd-ripple-effect" href="{{ url('/administrasi')}}">	
		...
		<li class="dropdown pmd-dropdown"> 
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">	
				<i class="material-icons media-left pmd-sm">person</i> 
				<span class="media-body">User</span>
				<div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
			</a> 
			<ul class="dropdown-menu">
				<li><a href="{{url('administrasi/form_user_baru')}}">Buat User Baru</a></li>
				<li><a href="{{url('administrasi/daftar_user')}}">Daftar User</a></li>
			</ul>
		</li>
		...
		<li class="dropdown pmd-dropdown"> 
			...
			<ul class="dropdown-menu">
				<li><a href="{{url('administrasi/form_pekerja_baru')}}">Input Pekerja Baru</a></li>
				<li><a href="{{url('administrasi/daftar_pekerja')}}">Daftar Berkas Pekerja</a></li>
				<li><a href="{{url('administrasi/pekerja_diterima')}}">Daftar Berkas Di terima</a></li>
				<li><a href="{{url('administrasi/pekerja_ditolak')}}">Daftar Berkas Di Tolak</a></li>
				<li><a href="{{url('administrasi/cetak_kimper')}}">Cetak Kimper Pekerja</a></li>
			</ul>
		</li>

		<li> 
			<a class="pmd-ripple-effect" href="{{ url('administrasi/notifikasi')}}">	
		...
		<li> 
			<a class="pmd-ripple-effect" href="{{ url('logout_administrasi')}}">	
				<i class="media-left media-middle">
