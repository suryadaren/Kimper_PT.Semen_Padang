...
<div class="container-fluid full-width-container data-tables">
    ...
    <h1 class="section-title" id="services">
      <span>Daftar Pekerja Aktif</span>
    </h1><!-- End Title -->
  
    <!--breadcrum start-->
    <ol class="breadcrumb text-left">
      <li><a href="{{ url('administrasi')}}">Dashboard</a></li>
      <li class="active">Daftar Berkas Pekerja Aktif</li>
    </ol><!--breadcrum end-->
        ...
        <div class="pmd-card pmd-z-depth pmd-card-custom-view">
          <table id="example" class="table pmd-table table-hover table-striped display responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr onclick="detail('{{$pekerja->id}}','{{$pekerja->nama}}','{{$pekerja->nip}}','{{$pekerja->unit_kerja}}')">
                <td>{{$pekerja->nip}}</td>
                <td>{{$pekerja->alamat}}</td>
                <td>{{$pekerja->nama}}</td>
                <td>{{$pekerja->email}}</td>

                @if($pekerja->status == null)
                <td>pending</td>
                @elseif($pekerja->status == "ok")
                <td>berkas di terima</td>
                @elseif($pekerja->status == "nok")
                <td>berkas ditolak</td>
                @elseif($pekerja->status == "lulus")
                <td>lulus</td>
                @elseif($pekerja->status == "tidak lulus")
                <td>tidak lulus</td>
                @elseif($pekerja->status == "aktif")
                <td>izin aktif</td>
                @elseif($pekerja->status == "naktif")
                <td>izin non aktif</td>
                @endif  
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <form name="form_detail" class="form-horizontal" action="{{url('administrasi/downloadPDF')}}" method="post">
                        <input type="hidden" name="id">
                        <h3 class="heading text-center" style="width: 100%">KIMPER</h3>
                        <h1 class="heading text-center" style="width: 100%">PT. Semen Padang</h1>
                        <p  class="heading text-center" style="width: 100%"><img src="{{ url('Admin/themes/images/user-icon.png')}}" alt="New User" style="width: 20%"></p>
                        <br>
                        <fieldset>
                          <div class="row">
                            <div class="col-sm-12">
                              ...
                              <div class="form-group pmd-textfield">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" class="form-control empty" id="inputEmail" value="AKTIF" style="color:blue">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="pmd-modal-action text-right">
                            <input class="btn pmd-ripple-effect btn-primary"  type="submit" value="Cetak">
...
function detail(id,nama,nip,unit_kerja){
