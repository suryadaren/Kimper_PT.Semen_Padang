            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <form name="form_detail" class="form-horizontal" action="{{url('kepala_unit/terima_berkas')}}" method="post">
                        ...
                        <fieldset>
                          ...
                          <div class="pmd-modal-action text-right">
                            <input type="submit" class="btn pmd-ripple-effect btn-primary" value="Terima">
                            <button class="btn pmd-ripple-effect btn-danger" type="button" onclick="decline()">Tolak</button>
                          </div>
                          {{csrf_field()}}
                          @method('put')
                      </form>
    ...
    <div class="container">
          ...
          <div class="modal fade" id="decline">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="myModalLabel">Konfirmasi Tolak Berkas</h4>
                </div>
                <div class="modal-body">
                  
                  <form name="form_decline" action="{{ url('kepala_unit/tolak_berkas')}}" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                      <input type="hidden" name="id"></div>
                      <div class="form-group">
                        <label class="control-label">Silahkan masukan komentar</label>
                        <textarea required class="form-control" required name="komentar"></textarea>
                      </div>
                      <br>
