							...
							@foreach($top_notifikasis as $notifikasi)
								@if($notifikasi->status == 'belum')
									<li class="list-group-item unread">
										<a href="{{url('kepala_unit/detail_notifikasi/'.$notifikasi->id.'/'.$notifikasi->pekerja_id)}}">
	...
	<ul class="nav pmd-sidebar-nav">
		...
		<li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
				<div class="media-body media-middle">Admin Kepala Unit</div>
				<div class="media-right media-middle"><i class="dic-more-vert dic"></i></div>
			</a>
		</li><!-- End user info -->
		
		<li> 
			<a class="pmd-ripple-effect" href="{{ url('/kepala_unit')}}">	
		...
		<li class="dropdown pmd-dropdown"> 
			...
			<ul class="dropdown-menu">
				<li><a href="{{url('kepala_unit/daftar_permintaan')}}">Daftar Permintaan</a></li>
				<li><a href="{{url('kepala_unit/daftar_berkas_diterima')}}">Daftar Berkas di Terima</a></li>
				<li><a href="{{url('kepala_unit/daftar_berkas_ditolak')}}">Daftar berkas di Tolak</a></li>
			</ul>
		</li>

		<li> 
			<a class="pmd-ripple-effect" href="{{ url('kepala_unit/notifikasi')}}">	
		...
		<li> 
			<a class="pmd-ripple-effect" href="{{ url('logout_kepala_unit')}}">	
				<i class="media-left media-middle">
